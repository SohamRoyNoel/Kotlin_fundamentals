...
fun main(args: Array<String>) {
    ...
    */
    ...
    /*
            Exception in thread "main" The length of name is null
            The length of name is -1
            kotlin.KotlinNullPointerException
            at others.NullSafeKt.main(nullSafe.kt:83)
    */
}